package com.food.ordering.system.order.query.service.common.api.error.handler;
...
@ControllerAdvice
public class OrderQueryServiceErrorHandler {

    private static final Logger LOG = LoggerFactory.getLogger(OrderQueryServiceErrorHandler.class);

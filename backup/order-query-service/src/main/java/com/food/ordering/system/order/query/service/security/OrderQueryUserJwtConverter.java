...
import static com.food.ordering.system.order.query.service.Constants.NA;


public class OrderQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public OrderQueryUserJwtConverter(OrderQueryUserDetailsService userDetailsService) {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                ...
                .map(userDetails -> {
                    ((OrderQueryUser) userDetails).setAuthorities(authoritiesFromJwt);

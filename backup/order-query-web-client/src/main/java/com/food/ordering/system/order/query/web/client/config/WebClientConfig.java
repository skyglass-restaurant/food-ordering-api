package com.food.ordering.system.order.query.web.client.config;
...
public class WebClientConfig {
    ...
    private final OrderQueryWebClientConfigData.WebClient elasticQueryWebClientConfigData;

    @Value("${security.default-client-registration-id}")
    private String defaultClientRegistrationId;


    public WebClientConfig(OrderQueryWebClientConfigData webClientConfigData) {

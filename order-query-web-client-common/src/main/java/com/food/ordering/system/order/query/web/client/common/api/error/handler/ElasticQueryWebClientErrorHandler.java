package com.food.ordering.system.order.query.web.client.common.api.error.handler;
...
public class ElasticQueryWebClientErrorHandler {
    ...
    public String handle(RuntimeException e, Model model) {
        ...
        model.addAttribute("elasticQueryWebClientRequestModel", OrderQueryWebClientRequestModel.builder().build());
